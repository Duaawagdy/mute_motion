...
//import 'package:mutuemotion/home/presentation/view/widgets/customtextfield.dart';
        ...
        body: Container(
          ...
          child:SingleChildScrollView(
            child: Column(
              ...
              children: [
                SizedBox(height: 20,),
                Text('Provide your feedback about your ride with this passenger',textAlign:TextAlign.center , style: TextStyle(
                ...
                RatingBar.builder(
                  ...
                  onRatingUpdate: (value) {
                    setState(() {
                      rating = value;
                      if (value == 1 ){rateComment = 'Awful';}
                      else if (value <3 ){rateComment = 'Weak';}
                      else if (value <4.5 ){rateComment = 'Good';}
                      else {rateComment = 'Excellent';}
                    });
                ...
                Text(rateComment!, style: TextStyle(
                    fontSize: 24, fontFamily: 'Lato', color: borderColor),),
                SizedBox(height: 7,),
                Text('You rated your passenger', style: TextStyle(
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      contentPadding: EdgeInsets.symmetric(vertical: 100.0, horizontal: 100), // Adjust the padding
                    ),
                  ),
                ),
                SizedBox(height: 15,),
